...
import fastagency_studio.app
import fastagency_studio.auth_token.auth
import fastagency_studio.db
import fastagency_studio.db.inmemory
import fastagency_studio.db.prisma
from fastagency_studio.app import app
from fastagency_studio.auth_token.auth import (
...
async def test_create_deployment_token(
    ...
    monkeypatch.setattr(
        fastagency_studio.db.inmemory.InMemoryBackendDB,
        "find_model",
        mock_find_model,
    )
