...
from fastagency.proxy import Proxy, get_params
...
def test_get_params_with_query_params_and_path_params() -> None:
    ...
    query_params, path_params, body = get_params(
        "/items/{item_id}/ships/{ship}",
...
def test_get_params_with_query_params_only() -> None:
    ...
    query_params, path_params, body = get_params("/items", update_item_get)  # type: ignore [arg-type]
    assert query_params == {"q1", "q2"}
...
def test_get_params_with_no_query_params_or_path_params() -> None:
    ...
    query_params, path_params, body = get_params("/items", delete_items)  # type: ignore [arg-type]
