...
const CustomSidebar = ({ sidebarOpen, setSidebarOpen, onMenuSelect }: SidebarProps) => {
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              {navLinkItems.map((item) => (
                <li key={item.label}>
                  <NavLink
                    to=''
                    className='group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-airt-secondary dark:hover:bg-meta-4'
                    onClick={(e) => {
                      e.preventDefault();
                      onMenuSelect(item.label.toLowerCase());
                    }}
                  >
                    {item.label}
                  </NavLink>
