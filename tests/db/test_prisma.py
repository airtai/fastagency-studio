...
from fastagency_studio.db.base import DefaultDB, KeyNotFoundError
from fastagency_studio.db.prisma import PrismaBackendDB, PrismaFrontendDB
...
class TestPrismaBackendDB:
    ...
    async def test_auth_token_CRUD(self, monkeypatch: pytest.MonkeyPatch) -> None:  # noqa: N802
        ...
        monkeypatch.setattr(
            fastagency_studio.db.prisma.PrismaBackendDB,
            "find_model",
            mock_find_model,
        )
